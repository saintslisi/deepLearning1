...
# --- PERCORSI ---
folder_gt = "../../dataset/test/groundtruth"      # Immagini originali
folder_restored = "results/final_images_100epochs"         # Immagini generate dal tuo modello
...
def main():
    ...
    for file_path in tqdm(files):
        ...
        if not os.path.exists(path_gt):
            print(f"⚠️ GT mancante per {img_name}, salto.")
            continue
