...
if __name__ == '__main__':
    flatten_folders('data/REDS/train/train_blur_jpeg')
    flatten_folders('data/REDS/train/train_sharp')

    # flatten_folders('data/REDS/val/val_blur_jpeg')
    # flatten_folders('data/REDS/val/val_sharp')
    # make_val_300('data/REDS/val/val_blur_jpeg', 'data/REDS/val/blur_300')
    # make_val_300('data/REDS/val/val_sharp', 'data/REDS/val/sharp_300')
