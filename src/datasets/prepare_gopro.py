...
def main():
    ...
    opt['input_folder'] = 'data/GoPro/train/input'
    opt['save_folder'] = 'data/GoPro/train/blur_crops'
    opt['crop_size'] = 512
    opt['step'] = 256
    opt['thresh_size'] = 0
    extract_subimages(opt)

    opt['input_folder'] = 'data/GoPro/train/target'
    opt['save_folder'] = 'data/GoPro/train/sharp_crops'
    opt['crop_size'] = 512
    opt['step'] = 256
    opt['thresh_size'] = 0
    extract_subimages(opt)
