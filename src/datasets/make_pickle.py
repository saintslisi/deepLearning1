...
PATH = 'data/SR/NTIRE22-StereoSR/Train'
...
import pickle
with open('data/ntire-stereo-sr.train.lr.pickle', 'wb') as f:
    pickle.dump(lr_lists, f)

with open('data/ntire-stereo-sr.train.hr.pickle', 'wb') as f:
...
# np.save('data/ntire-stereo-sr.train.lr.npy', lr_all_np)
# np.save('data/ntire-stereo-sr.train.hr.npy', hr_all_np)
