...
from src.datasets.srgan_dataset import CUDAPrefetcher, PairedImageDataset
from src.utils.imgproc import tensor_to_image
from src.utils.srgan_utils import build_iqa_model, load_pretrained_state_dict, make_directory, AverageMeter, ProgressMeter, Summary
...
def main() -> None:
    ...
    parser.add_argument("--config_path",
                        type=str,
                        default="experiments/configs/srgan/SRGAN_DIV2k_Test_128px.yaml",
                        required=True,
