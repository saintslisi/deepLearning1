...
from src.utils.imgproc import preprocess_one_image, tensor_to_image
from src.utils.srgan_utils import load_pretrained_state_dict
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_weights_path",
                        type=str,
                        default="data/pretrained_models/SRGAN_x4-ImageNet.pth.tar",
