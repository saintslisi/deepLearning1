...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--pretrain_weights',type=str, default='experiments/logs/Uformer_B/models/model_best.pth', help='path of pretrained_weights')
        ...
        # args for saving 
        parser.add_argument('--save_dir', type=str, default='experiments/logs/',  help='save dir')
