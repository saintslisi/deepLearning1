...
from src.models import srgan as model
from src.datasets.srgan_dataset import CUDAPrefetcher, BaseImageDataset, PairedImageDataset
from src.utils.imgproc import random_crop_torch, random_rotate_torch, random_vertically_flip_torch, random_horizontally_flip_torch
from test import test
from src.utils.srgan_utils import build_iqa_model, load_resume_state_dict, load_pretrained_state_dict, make_directory, save_checkpoint, \
...
def main():
    ...
    parser.add_argument("--config_path",
                        type=str,
                        default="experiments/configs/srgan/SRResNet_DIV2K_Noisy_128px.yaml",
